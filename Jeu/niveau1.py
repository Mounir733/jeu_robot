...
def main_game():
    ...
    while running:
        ...
        # Si le fond atteint la fin de l'image, réinitaliser à 0
        fond_x = 0
        ...
        # Collisions obstacles et joueur
        collisions = pygame.sprite.spritecollide(player, obstacles_group, False)
        if collisions:
            # Réinitialisez la position du joueur à la position précédente
